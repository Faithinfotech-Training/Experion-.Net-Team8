...
export class AppointmentService {
  ...
  InsertAppoinment(appointment: Appointment):Observable<any>{
    return this.httpClient.post(
      environment.apiUrl + '/api/appointment', appointment
    )
  }
  ...
  GetAllAppoinments(){
    this.httpClient.get(environment.apiUrl + '/api/appointment').toPromise()
  ...
  GetAllAppointmentsByDate(appDate: Date): Observable<any> {
    return this.httpClient.get(environment.apiUrl + '/api/appointment/'+ appDate);
  }

  //view all appointments by doctor
  GetAllAppointmentsByDoctor(empId: number): Observable<any> {
    return this.httpClient.get(environment.apiUrl + '/api/appointment/'+ empId);
  }
}
